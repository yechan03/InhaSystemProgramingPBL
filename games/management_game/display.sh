...
display_menus() {
    case $GAMESTATE in
        ...
        "BUY")
            ...
            echo "5. coal ($todayCoalCost money)"
            echo "6. iron ore ($todayIronOreCost money)"
            echo "7. iron ($todayIronCost money)"
            echo "8. steel ($todaySteelCost money)"
            ;;
        "SELL")
            echo "1. coal ($todayCoalCost money)"
            echo "2. iron ore ($todayIronOreCost money)"
            echo "3. iron ($todayIronCost money)"
            echo "4. steel ($todaySteelCost money)"
